...
# ==========================================
# 1. MOBILE APP SYNC ENDPOINTS (Person A Interface)
# ==========================================

@app.get("/api/v1/sync/symptoms", tags=["Sync"])
def sync_symptoms():
    """Fetch symptoms list for mobile app local sync."""
    try:
...
def sync_diseases():
    """Fetch diseases list for mobile app local sync."""
    try:
...
def push_diagnosis_record(record: dict):
    """Receive diagnosis records synced from Flutter app."""
    try:
...
# ==========================================
# 2. SIMPLE WEB DASHBOARD (Person C Interface)
# ==========================================

@app.get("/dashboard", response_class=HTMLResponse, tags=["Dashboard"])
def web_dashboard():
    """Render a simple Web Dashboard showing database status and diagnostic logs."""
    ...
    <head>
        ...
        <style>
            ...
            .card h3 {{ margin: 0; color: #4a5568; font-size: 14px; text-transform: uppercase; }}
    ...
    <body>
        ...
        <p>Live sync metrics from MongoDB (Port 27018)</p>
